...
class admin extends CI_Controller
{
    ...
    public function updatePassword()
    {
        ...
        if($result == "Y")
        {
            ...
            */
            $mail->Username = "omer Farooq"; // SMTP username
            $mail->Password = "classix"; // SMTP password

            /*
            *  Configurations
            */
            $webmaster_email = "omer.4uq@outlook.com"; //Reply to this email ID

            /*
            *  From
            */
            $mail->From = $webmaster_email;
            $mail->FromName = "support@PnL.com";
            /*
            *  To
            */
            ...
            */
            $mail->Subject = "Play and Learn - Password Changed";
